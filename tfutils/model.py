...
from tfutils.model_tool import ConvNet as ConvNet_new
from tfutils.model_tool import mnist_tfutils as mnist_tfutils_new
from tfutils.model_tool import alexnet_tfutils as alexnet_tfutils_new

# Model building tool used for previous users
# This tool is too complicated to understand and no longer recommended at all!
from tfutils.model_tool_old import ConvNet, mnist_tfutils, alexnet_tfutils
